    ...
    <div className="min-h-screen bg-[#FAF9F6]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-8 space-y-8">
        ...
        <section>
          ...
          <p className="text-sm text-[#6B6B6B] mb-4">
            This information will appear at the end of every report. Signatures are collected securely via Adobe Sign.
          </p>
          <div className="bg-white rounded-lg border border-[#E5E1D8] p-6 space-y-4">
            <div>
            ...
            {/* Preview */}
            {(settings.signatureName || settings.signatureTitle || settings.signatureLicense || settings.signatureEmail) && (
              <div className="border-t border-[#E5E1D8] pt-4 mt-4">
                ...
                <div className="bg-[#FAF9F6] rounded-md p-4 border border-[#E5E1D8] font-serif text-sm text-slate-800">
                  <div className="h-12 border-b border-slate-300 w-48 mb-2">
                    <span className="text-xs text-[#8B8B8B] italic">Signature collected via Adobe Sign</span>
                  </div>
